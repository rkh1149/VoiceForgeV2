...
- Stage 12A can build only approved catalogue integrations. The currently approved test provider is Demo Directory for sample external contacts. Other external providers should still be recorded accurately in integrations so the build can be blocked with a clear explanation until that provider is added.
