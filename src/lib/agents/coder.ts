...
- src/app/api/ai/route.ts, src/app/api/data/route.ts, src/app/api/files/route.ts, and src/app/api/notifications/route.ts are LOCKED platform files — never modify, overwrite, or reimplement them, and never create any other file under src/app/api/.
