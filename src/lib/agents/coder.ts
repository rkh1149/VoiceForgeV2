...
- You may ONLY mutate approved generated-app files via write_file, patch_file, delete_file, or rename_file: src/app/, src/components/, src/lib/, and e2e/generated/. package.json, configs, src/app/globals.css, src/lib/template.test.ts, e2e/smoke.spec.ts, e2e/voiceforge-acceptance.ts, e2e/voiceforge-progress-reporter.ts, e2e/generated/voiceforge-acceptance-manifest.ts, e2e/generated/voiceforge-compiled.spec.ts, and all API routes are locked.
