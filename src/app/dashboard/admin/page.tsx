...
export default async function AdminPage() {
  ...
  const [
    ...
    db.select({ platformSearchConfigCount: count() }).from(appRecordSearchConfigs),
    db.select({ savedFilterCount: count() }).from(appSavedRecordFilters),
  ...
  const stats = [
    ...
    { label: "Search configs", value: platformSearchConfigCount },
    { label: "Saved filters", value: savedFilterCount },
